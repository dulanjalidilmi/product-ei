 ...
 * api service, the POX message will be transformed to JSON using Payload Factory Mediator and send the message to
...
public class PoxToJsonUsingPayloadFactoryTest extends ScenarioTestBase {
    ...
    private String cappNameWithVersion = "approach_1_2_1_synapse_configCompositeApplication_1.0.0";
    private String apiName = "1_2_1_pox_to_json_using_payload_factory";
    ...
    @Test(description = "1.2.1.1-Valid pox To Json transformation Using Payload Factory Mediator", enabled = true,
          dataProvider = "1.2.1.1")
    public void convertValidPoxToJsonUsingPayloadFactory(String request, String expectedResponse, String header) throws Exception {
    ...
    @Test(description = "1.2.1.2-Malformed pox To Json transformation Using Payload Factory Mediator", enabled = true,
          dataProvider = "1.2.1.2")
    public void convertMalformedPoxToJsonUsingPayloadFactory(String request, String expectedResponse, String header) throws Exception {
        log.info("apiInvocationUrl is set as : " + apiInvocationUrl);
    ...
    @DataProvider(name = "1.2.1.1")
    public Iterator<Object[]> poxToJson_1_2_1_1() throws Exception {
        String testCase = "1.2.1.1";
        return getRequestResponseHeaderList(testCase).iterator();
    }

    @DataProvider(name = "1.2.1.2")
    public Iterator<Object[]> poxToJson_1_2_1_2() throws Exception {
        String testCase = "1.2.1.2";
        return getRequestResponseHeaderList(testCase).iterator();
    }
}
